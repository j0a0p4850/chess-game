...
public class Board {
	...
	public void placePiece(Piece piece, Position position) {
		...
		// aqui a posição da peça nao sera mais nula
	
		
		/*Assim vai na matriz de peças 
		 * na linha e na coluna e atribuir esta posição da matriz de peças
